Public Class Layer_Number
    ...
    Public Overrides Sub Paint(g As Graphics)
        ...
        Dim t As SizeF = g.MeasureString(Number, f)
        ...
        g.DrawEllipse(New Pen(Pen.Color, Pen.Width \ 2 + 1) With {.Alignment = Drawing2D.PenAlignment.Outset}, rb)
        g.DrawString(Number, f, Brushes.Black, r.X - t.Width / 2, r.Y - ((t.Height + s) / 4))
    End Sub
End Class
