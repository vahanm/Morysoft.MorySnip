...
namespace Morysoft.MorySnip
{
    ...
    public partial class FormSettings : Form
    {
        ...
        internal Button BrowseLocalButton
        {
            ...
            set
            {
                if (browseLocalButton != null)
                {
                    browseLocalButton.Click -= Button_Browse_Click;
                }

                browseLocalButton = value;
                if (browseLocalButton != null)
                {
                    browseLocalButton.Click += Button_Browse_Click;
                }
        ...
        internal CheckBox OpenFolderCheckBox
        {
            [MethodImpl(MethodImplOptions.Synchronized)]
            get
            {
                return openFolderCheckBox;
            }
        ...
        internal ComboBox ImageTypeComboBox
        {
            [MethodImpl(MethodImplOptions.Synchronized)]
            get
            {
                return imageTypeComboBox;
            }

            [MethodImpl(MethodImplOptions.Synchronized)]
            set
            {
                if (imageTypeComboBox != null)
                {
                    imageTypeComboBox.SelectedIndexChanged -= ComboBox_Type_SelectedIndexChanged;
                }

                imageTypeComboBox = value;
                if (imageTypeComboBox != null)
                {
                    imageTypeComboBox.SelectedIndexChanged += ComboBox_Type_SelectedIndexChanged;
                }
        ...
        internal CheckBox CopyPathCheckBox
        {
            [MethodImpl(MethodImplOptions.Synchronized)]
            get
            {
                return copyPathCheckBox;
            }

            [MethodImpl(MethodImplOptions.Synchronized)]
            set
            {
                if (copyPathCheckBox != null)
                {
                }

                copyPathCheckBox = value;
                if (copyPathCheckBox != null)
                {
                }
            }
