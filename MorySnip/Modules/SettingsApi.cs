...
namespace Morysoft.MorySnip
{
    public static class SettingsApi
    {
        ...
        public static bool GetSettingBool(string name, bool defaultValue = false) => SettingsApi.GetSettingInt(name, defaultValue ? 1 : 0) != 0;

        public static void SetSettingBool(string name, bool value) => SettingsApi.SetSettingInt(name, value ? 1 : 0);
